...
import { LogOut, Plus, Edit2, Trash2, Upload, AlertCircle, Check } from 'lucide-react';
      ...
      <header className="bg-white border-b-2 border-[#f9d2a3] shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <h1 className="text-3xl font-bold text-[#ab4b28] [font-family:'Poppins',Helvetica]">
            MEHER Admin Dashboard
          </h1>
          <button
            onClick={handleLogout}
            className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-colors [font-family:'Poppins',Helvetica]"
          >
