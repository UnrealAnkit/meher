          ...
          try {
            if (response.error) {
              const failedParams = new URLSearchParams({
                ...
                payment_page: '/book-stay/earth-and-clay',
              });
              setSubmitting(false);
            ...
            const bookingData = {
              ...
              event_date: new Date().toLocaleDateString(),
              selected_slot: 'Earth & Clay Room',
              price: `₹${price.toLocaleString('en-IN')}`,
              customer_name: customerData.name,
              customer_email: customerData.email,
              customer_phone: customerData.phone,
              status: 'confirmed',
              notes: 'Earth & Clay Room Booking',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:items-stretch">
            ...
            <div className="relative w-full h-full rounded-lg overflow-hidden">
              <img
                ...
                alt="Earth and Clay Room View 1"
            ...
            <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 h-full">
              ...
              <div className="relative w-full flex-1 rounded-lg overflow-hidden">
                <img
                  ...
                  alt="Earth and Clay Room View 2"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 flex-1">
                <div className="relative w-full h-full rounded-lg overflow-hidden">
                  <img
                    src="https://meher.b-cdn.net/Group%20Yoga%20class%20Marbella%20(19).png"
                    alt="Earth and Clay Room View 3"
                    className="w-full h-full object-cover"
                    loading="lazy"
                  />
                </div>
                <div className="relative w-full h-full rounded-lg overflow-hidden">
                  <img
                    src="https://meher.b-cdn.net/Group%20Yoga%20class%20Marbella%20(20).png"
                    alt="Earth and Clay Room View 4"
                    className="w-full h-full object-cover"
                    loading="lazy"
                  />
                </div>
