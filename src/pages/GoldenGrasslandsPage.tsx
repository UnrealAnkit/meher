...
export const GoldenGrasslandsPage = (): JSX.Element => {
  ...
  async function handlePayment() {
    ...
    try {
      ...
      const description = `Golden Grasslands Room Booking`;
          ...
          try {
            if (response.error) {
              const failedParams = new URLSearchParams({
                ...
                event_name: 'Golden Grasslands Room Booking',
                ...
                payment_page: '/book-stay/golden-grasslands',
              });
              setSubmitting(false);
            ...
            const bookingData = {
              event_id: null,
              event_title: 'Golden Grasslands Room Booking',
              event_date: new Date().toLocaleDateString(),
              selected_slot: 'Golden Grasslands Room',
              price: `₹${price.toLocaleString('en-IN')}`,
              customer_name: customerData.name,
              customer_email: customerData.email,
              customer_phone: customerData.phone,
              status: 'confirmed',
              notes: 'Golden Grasslands Room Booking',
  ...
  return (
    <div className="bg-white overflow-hidden w-full relative min-h-screen flex flex-col">
      ...
      <section className="relative w-full bg-white">
        <video
          src="https://meher.b-cdn.net/Golden%20Grasslands.mp4"
          autoPlay
          loop
          muted
          playsInline
      ...
      <section className="relative w-full flex justify-center py-8 sm:py-12 md:py-16 lg:py-20 bg-white px-4 sm:px-6 md:px-8">
        <div className="w-full max-w-7xl">
          ...
          <div className="space-y-4 sm:space-y-6">
            <p className="[font-family:'Poppins',Helvetica] font-normal text-[#555555] text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed w-full">
              Cheerful, rustic, and abundantly alive — a radiant ode to sunlight, simplicity, and the joy of everyday moments.
            </p>
            <p className="[font-family:'Poppins',Helvetica] font-normal text-[#555555] text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed w-full">
              Shades of ochre, wheat, and leaf-green fill the space with warmth and golden light, evoking the richness of a harvest morning.
            </p>
            <p className="[font-family:'Poppins',Helvetica] font-normal text-[#555555] text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed w-full">
              It's a place that hums with gratitude — where the heart feels open, the soul feels full, and life unfolds in its most honest, sunlit form.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:items-stretch">
            ...
            <div className="relative w-full h-full rounded-lg overflow-hidden">
              <img
                src="https://meher.b-cdn.net/Group%20Yoga%20class%20Marbella%20(27).png"
                alt="Golden Grasslands Room View 1"
            ...
            <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 h-full">
              ...
              <div className="relative w-full flex-1 rounded-lg overflow-hidden">
                <img
                  src="https://meher.b-cdn.net/Group%20Yoga%20class%20Marbella%20(28).png"
                  alt="Golden Grasslands Room View 2"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 flex-1">
                <div className="relative w-full h-full rounded-lg overflow-hidden">
                  <img
                    src="https://meher.b-cdn.net/Group%20Yoga%20class%20Marbella%20(29).png"
                    alt="Golden Grasslands Room View 3"
                    className="w-full h-full object-cover"
                    loading="lazy"
                  />
                </div>
                <div className="relative w-full h-full rounded-lg overflow-hidden">
                  <img
                    src="https://meher.b-cdn.net/Group%20Yoga%20class%20Marbella%20(30).png"
                    alt="Golden Grasslands Room View 4"
                    className="w-full h-full object-cover"
                    loading="lazy"
                  />
                </div>
